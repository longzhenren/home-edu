...
import com.amur.home.admin.mapper.HomeInfoMapper;
...
public class HomeInfoServiceImpl extends ServiceImpl<HomeInfoMapper, HomeInfo> implements HomeInfoService {
    ...
    @Override
    public Page<HomeInfo> queryHomeInfos(Map<String, Map<String, Object>> params, String sortField, String sortOrder, Integer pageNumber, Integer pageSize) {
        ...
        return HomeInfoMapper.selectPage(page, queryWrapper);
    }
}
