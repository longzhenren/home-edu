 ...
 */
package com.amur.home.secure.utils;

import com.amur.home.common.constant.TokenConstant;
import com.amur.home.core.tool.constant.RoleConstant;
import com.amur.home.core.tool.utils.*;
import com.amur.home.secure.BladeUser;
import com.amur.home.secure.TokenInfo;
import com.amur.home.secure.constant.SecureConstant;
import com.amur.home.secure.exception.SecureException;
import com.amur.home.secure.props.AmurTokenProperties;
import com.amur.home.secure.provider.IClientDetails;
...
public class SecureUtil {
    private static final String AMUR_USER_REQUEST_ATTR = "_AMUR_USER_REQUEST_ATTR_";
    ...
    private final static String HOME_ID = TokenConstant.HOME_ID;
    ...
    private static AmurTokenProperties TOKEN_PROPERTIES;
     ...
     */
    private static AmurTokenProperties getTokenProperties() {
        if (TOKEN_PROPERTIES == null) {
            TOKEN_PROPERTIES = SpringUtil.getBean(AmurTokenProperties.class);
        }
    ...
    public static BladeUser getUser() {
        ...
        // 优先从 request 中获取
        Object bladeUser = request.getAttribute(AMUR_USER_REQUEST_ATTR);
        if (bladeUser == null) {
            bladeUser = getUser(request);
            if (bladeUser != null) {
                // 设置到 request 中
                request.setAttribute(AMUR_USER_REQUEST_ATTR, bladeUser);
            }
        }
    ...
    public static BladeUser getUser(HttpServletRequest request) {
        ...
        String homeId = Func.toStr(claims.get(SecureUtil.HOME_ID));
